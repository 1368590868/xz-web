...
import left1 from '~/assets/images/hyzhfw/left1.png'
import banner from '~/assets/images/hyzhfw/banner.jpg'
// compiler micro
definePageMeta({ layout: 'page' })
useHead({ title: '行业综合服务' })
</script>
  ...
  <div class="w-full">
    ...
    <div class="bg-[#F6F7FB] w-full">
      <LayoutPageWrapper>
        ...
        <div class="flex md:gap-[54px] md:flex-row flex-col justify-between items-center max-w-[991px]">
          <div class="flex justify-center">
            <img class="md:w-full w-[50%]" loading="lazy" :src="left1" />
          </div>
    ...
    <div class="bg-[#FBFBFB] w-full">
      <LayoutPageWrapper>
        ...
        <div class="flex md:gap-[20px] md:flex-row flex-col justify-between max-w-[1200px] md:mt-[69px] mt-[20px]">
          <div class="md:w-[537px]   font-normal text-[#0d0d0d] leading-6 indent-8">
            <div class="text-[20px] md:text-left text-center text-blank font-bold indent-0 mb-[24px]">
              铁科院多业务板块长期合作
            </div>
            <div class="mb-[24px]">
          ...
          <div>
            <img class="md:mt-0 mt-[20px]" loading="lazy" :src="rightLogo" :height="308" />
          </div>
        </div>
        <div class="max-w-[1200px] mb-[50px]">
          <div class="text-[26px] text-black font-bold md:mt-0 mt-[20px] md:text-left text-center">合作业务板块</div>
          <div class="  text-[#0d0d0d] font-normal mt-[20px] indent-8">
