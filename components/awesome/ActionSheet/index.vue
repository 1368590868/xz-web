...
<template>
  <Teleport to="body">
    <HeadlessTransitionRoot :show="isShow"
      ...
      enter="transition-opacity duration-300" enter-from="opacity-0" enter-to="opacity-100"
      ...
      <div class="flex flex-col overflow-hidden relative">
        <div class="action-sheet-container flex-1 overflow-y-auto space-y-1 justify-end px-4 pb-2 pt-4">
          ...
          <AwesomeActionSheetGroup v-if="closeButton">
            <AwesomeActionSheetItemButton class="text-red-500 font-bold" :text="closeButtonText" @click="close" />
