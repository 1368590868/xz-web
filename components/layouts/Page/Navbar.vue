...
<template>
  <header
    class="flex fixed p-[5px] top-0 z-40 w-full flex-none transition-colors duration-300 lg:z-50 border-gray-950/10 dark:border-gray-50/[0.2] bg-[#000000]/[0.27] dark:bg-gray-950/[0.5]">
    <!-- content -->
